  ...
  return <footer className="site-footer">
    <div className="inner">
      ...
      <nav aria-label="Footer" style={{ display: 'grid', gap: 6 }}>
        <a href="/#how-it-works">How it works</a><a href="/pricing">Pricing</a><a href="/pricing#faq">FAQ</a><a href="/request-access">Request access</a><a href="/auth/signin">Sign in</a>
      </nav>
